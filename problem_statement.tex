...
Since, we only have to propagate updates for a sample, there is further a new challenge in how to most efficiently execute this procedure to avoid irrelevant computation. 
