...
SVC is complementary to existing maintenance algorithms, recomputation, IVM, or higher order like DBToaster, provided they are specified in standard relational algebra.
