...
The problem of high computational costs for accurate results mirrors the challenge faced in the MV setting with the tradeoff between immediate maintenance (inexpensive and inaccurate) and deferred maintenance (expensive and accurate).
...
The first challenge is about data cleaning. 
In SampleClean, we modeled data cleaning as a row-by-row transformation of table. 
