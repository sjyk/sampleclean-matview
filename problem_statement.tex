...
Inspired by this solution, we apply a data cleaning cleaning approach to materialized views where for aggregate queries (\sumfunc, \countfunc, and \avgfunc), we correct their stale results from a sample of up-to-date data.
