...
When new records arrive at a fast rate, it is infeasible to continously update (maintain) MVs and a common solution is to defer maintenance by batching updates together.
