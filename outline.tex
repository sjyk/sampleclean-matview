...
We evaluate our method on a real dataset of server logs from Conviva and the TPCD benchmark dataset and our experiments confirm our theoretical result: (1) cleaning an MV sample is more efficient than full view maintenance, (2) the corrected results are more accurate than using the stale MV, and (3) SVC can be efficiently integrated with deferred maintenance. 
\end{abstract}
