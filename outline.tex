...
In \emph{Sample-View-Clean}, we take inspiration from recent data cleaning results that greatly improve query accuracy by cleaning a sample of dirty data. 
