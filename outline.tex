...
To complement existing deferred maintenance approaches, we use a sample of \emph{update patterns} to correct stale query results between maintenance periods, without the cost of full maintenance. 
%We define the concept of an update pattern and propose efficient techniques to maintain a sample of update patterns for three classes of materialized views. 
