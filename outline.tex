...
In \svc, we efficiently clean the data error in sample of rows from a stale MV, and use the clean sample to correct incorrect query results on the stale view.
