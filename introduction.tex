...
This model raises a new possibility for materialized views, namely, that a sample of up-to-date data can be used to answer aggregate queries without having the maintain the entire materialized view.
