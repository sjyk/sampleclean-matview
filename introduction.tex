...
After cleaning, to answer a query, we can analyze how that sample has changed from updates to the base data, and calculate a correction for incorrect query answers on the stale view that compensates for staleness. 
