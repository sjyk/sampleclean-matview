...
However, staleness is very different from the data errors considered in SampleClean not only resulting in erroneous data but potentially leading to missing data, and this raises interesting new challenges in sampling, correction, and query processing.
