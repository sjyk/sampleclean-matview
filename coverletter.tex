...
\item We revised our overview section (Section 3) to formalize our problem setting, assumptions, terminology, and key prerequisite concepts and includes more formal problem statements.
...
However, the materialized view problem setting adds new challenges that prior work does not address.
