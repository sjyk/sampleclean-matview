...
\reminder{I would suggest to merge Sec 7.2 and 7.7 into the  section of ``Accuracy" and merge Sec 7.3 and 7.4 and 7.5 into the section of ``efficiency". You can use the subtitle as follows }
...
\centering
 ...
 \caption{The overhead introduced by correcting a query is small compared to the overall maintenance time. \reminder{Why do you choose 50\%? I would only choose 1\%, 5\%, 10\% as Figure 4.}}
\end{figure}
