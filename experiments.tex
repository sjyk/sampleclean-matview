...
We implement SVC's sampling operator \reminder{sampling operator or hashing function?} with a linear hash writter in C that is evoked in MySQL as a stored procedure.
...
\textbf{Data Cube: } Another application which is common in industry analytics is data cube.
