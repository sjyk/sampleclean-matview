...
%\iffalse
The incremental maintenance algorithm used in our experiments is the ``change-table" used in numerous works in incremental maintenance \cite{gupta1995maintenance,gupta2006incremental, DBLP:journals/vldb/KochAKNNLS14}.
