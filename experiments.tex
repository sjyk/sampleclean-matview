...
We construct a separate in-memory temporary table of updates, and then measure the time needed to propagate the necessary updates (forming the delta table and writing the updates) to the views.
