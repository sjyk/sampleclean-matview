...
Refer to our extended paper on more details about the experimental setup \reminder{tr}.
\iffalse
...
\centering
\includegraphics[scale=0.145]{exp/msj_1.pdf}
\includegraphics[scale=0.145]{exp/msj_2.pdf}\vspace{-1em}
...
\begin{figure}[t]\vspace{-2em}
\centering
\includegraphics[scale=0.15]{exp/msj_3.pdf}
...
\begin{figure}[t]
\centering
 \includegraphics[scale=0.16]{exp/msdc_3.pdf}\vspace{-.5em}
...
\textbf{Other Queries: } In the extended version of the paper, we evaluate the median query \reminder{TR}.
...
\begin{figure}[t]\vspace{-2em}
\centering
 \includegraphics[scale=0.15]{exp/msqv_1.pdf}
 \includegraphics[scale=0.15]{exp/msqv_2.pdf}
...
\begin{figure}[t]
\centering
 \includegraphics[scale=0.15]{exp/msoi_1.pdf}
 \includegraphics[scale=0.15]{exp/msoi_2.pdf}\vspace{-1em}
...
\centering
 ...
 \includegraphics[scale=0.16]{exp/con_4.pdf} \vspace{-1.0em}
...
\begin{figure}[t]
\centering
 \includegraphics[scale=0.15]{exp/con_1.pdf}
 \includegraphics[scale=0.15]{exp/con_2.pdf}
...
\begin{figure}[t]
\centering
 \includegraphics[scale=0.15]{exp/con_5.pdf}
 \includegraphics[scale=0.15]{exp/con_6.pdf}
 \caption{For a fixed throughput, SVC+Periodic Maintenance gives more accurate results for V2 and V5. \label{conv-4}} 
\end{figure}

\begin{figure}[t]
\centering
\includegraphics[scale=0.15]{exp/con_7.pdf}
