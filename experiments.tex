...
The base dataset is 10GB corresponding to 60M records, and the above three views are derived from this base dataset.
\reminder{Include view sizes in the description}
