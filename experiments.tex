...
We derived the views from a 120GB base relation and inserted records in 10GB increments. \reminder{fix for consistency 4x to all sizes due to the _text dataset}
