...
As a baseline, we compare against SAQP with the sample sampling ratio (5\%) and no maintenance (i.e., the stale error).
...
In this experiment, we exclude SAQP since for the same sampling ratio SAQP and SVC require the same amount of time.
