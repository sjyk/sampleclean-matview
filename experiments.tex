...
\centering
 ...
 \caption{(a) We compare the maintenance time of SVC-10 and full incremental maintenance, and find that as with TPCD SVC saves significant maintenance time. (b) We also compare SVC to SVC+AQP and No Maintenance and find it is more accurate. \label{conv-1}}
\end{figure}
