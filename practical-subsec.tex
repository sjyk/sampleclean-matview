...
In comparison to SAQP, we leverage the existing stale view to use the exact selection up-to the last maintenance time avoiding estimating the entire result from the sample.
