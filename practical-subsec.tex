...
The only term in the correction that is not deterministic is $\dans$. \reminder{Does it still hold for the average query of \spview/\fjview?}
...
\end{proposition}
\reminder{It is unclear to me what does ``linear estimators" mean?}
