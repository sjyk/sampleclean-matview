...
The intuition is that these records greatly increase the variance of the data and since they are likeley rare the probability of sampling them is low leading to wildly varying estimates when the sample contains and outlier and when it does not contain any outliers.  
