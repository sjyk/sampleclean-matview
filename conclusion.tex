...
allow for accurate query processing on stale views for a fraction of the cost of incremental maintenance. \reminder{Add more conclusions we made in our paper. That is, the take-aways from the paper. For example, (1) SVC+periodic maintenance makes sense!; (2) SVC is much more efficient than full maintenance for a variety of views; (3) correction is more accurate than SAQP;   (4) Ourlier Indexing improves query accuracy a lot with little additional overhead, etc.  }
