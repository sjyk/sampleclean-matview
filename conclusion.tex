...
Materialized view maintenance is often expensive, and in practice, many prefer deferred maintenance solutions.
However, this leads to stale materialized views which have incorrect, missing, and superfluous rows.
In this work, we formalize view maintenance as a data cleaning problem.
...
To achieve this, we significantly extended our prior work in data cleaning, SampleClean \cite{wang1999sample}, for efficient cleaning of stale MVs, to general aggregate queries, missing data errors, and proved for which queries optimality of the estimates hold.
