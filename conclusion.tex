...
In terms of queries on the view, as with previous work in AQP, sampling is best suited for aggregate queries \cite{olken1993random}.
...
Finally, distinct count estimation from a sample is a known problem which potentially limits the types of queries on the MVs that \svc can support, excluding arbitrary nested queries.
