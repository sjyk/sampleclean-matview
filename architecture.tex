...
Then, we formalize the two main problems that SVC addresses: (1) materialized view maintenance as data cleaning and optimizing this data cleaning, and (2) query processing on stale materialized views with a sample of up-to-date data.
...
\subsection{Example Application: Server Log Analysis}
