...
For these materialized views, we model updates to the base tables as deletions and insertions.
...
In Section \ref{sec:del}, we discuss how to modify our query processing to support deletions.
