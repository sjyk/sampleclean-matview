...
\begin{definition}[Correspondence] \reminder{I swap the order of deletion and updating. I also remove a few items. Please check whether it makes sense or not. }
