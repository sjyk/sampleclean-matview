...
In this work, we model this problem as a data cleaning problem and explore whether full incremental maintenance is neccessary for up-to-date results.
Given an aggregation query (SUM, COUNT, AVG) on a stale materialized view, we use a sample of up-to-date (clean) data to estimate how much that data changes the stale aggregation query result.
