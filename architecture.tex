...
\]
\item Apply the generalized projection operator to add the visitCount in the delta view to each of the rows in visitView and treating the outer join NULL for either visitView or the ``delta view" as 0: \reminder{this sentence is a little hard to parse.}
\[
