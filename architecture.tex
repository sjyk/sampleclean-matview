...
Finally, we overview the \svc workflow. 
...
The maintenance strategy (visualized in Figure \ref{maintstrat}) for this view is as follows (for simplicity consider the case with no deletions):
\vspace{-.55em}
...
\subsection{Example}\label{infexample}
We describe the \svc framework with our running example \tbl{visitView}.
