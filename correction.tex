...
An \emph{update pattern} represents how an update to the base table affects a materialized view derived from that table.
We define this information to be such that if we did not sample (ie. 100\% sample) the information would be sufficient to transform the stale view to the corresponding up-to-date view exactly. 
