...
Another benefit of deterministic hashing is that when applied in conjuction to the primary keys of a view, we get the Correspondence Property (Definition \ref{correspondence}) for free.
