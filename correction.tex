...
To sample the groups, we apply a hash function to the group key. We define a hash function, $\hashfunc{\cdot}$, which takes a single group key as an input and outputs a number in the range of [0, 1], and filter
