...
\label{lin}
To understand this commutativity problem, consider the maintaining a group by aggregate:
...
Instead, we get a view where every count is partial and this is not what we want.
