...
\centering
 \includegraphics[scale=0.18]{figs/primary_key.png} \vspace{-.5em}
 \caption{Applying the rules described in Definition \ref{pk}, we illustrate how to assign a primary key to a view. \reminder{Why did visitView have ownerId and duration instead of visitCount? } \label{pk-fig}}\vspace{-1em}
\end{figure}
...
To ensure that this view has a primary key for all subexpressions, we apply the rules.
...
We can add this attribute by generating an increasing sequence of integers for each record in \tbl{Log}. ]]] \reminder{It looks a little confusing to put this sentense here. You can talk about it earlier.}
...
\begin{figure}[t] \vspace{-2em}
\centering
 \includegraphics[scale=0.18]{figs/example_expression_tree_2.pdf} \vspace{-.5em}
