...
\section{Correcting Stale Query Results}\reminder{TODO}
In this section, we discuss how to correct stale query results using sampled update patterns. We first present the principle of this query processing in Section~\ref{subsec:correct-principle} and then describe how to implement it practically in Section~\ref{subsec:correct-practical}.
\subsection{Correcting Query Processing}\label{subsec:correct-principle}
