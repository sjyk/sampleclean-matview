...
If we only consider insertions to the base table, the combined size of these two tables are guaranteed to be less than the size
of the fully maintained view; thus actually leading to a reduced query time.
