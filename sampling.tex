...
As input \nsc is given a query (\sumfunc, \countfun, or \avgfunc), the result of running this query on the dirty data, and a dirty sample and a cleaned version of the sample.
