...
\reminder{The content of the section is not very easy to follow. Since we may not include this section into our VLDB paper, it should be fine.  }
...
If the difference is small, i.e. $S$ is nearly identical to $S'$,then $cov(S,S') \approx \sigma_{S}^2$ and it is clearly less than 0. \reminder{This is not enough to claim that correction is better than AQP in many cases.}
...
This is due to the linearity of expectation operator. \reminder{I did not get this point. What are key
statistical properties and expectation operator?}
...
\[m(1-m)\mu_k^2+(1-m)\sigma_k^2\] \reminder{How did you get the equation?}
...
On the other hand this approach, does allow for better support for very selective queries on the view. \reminder{Why is it better for selective queries?}
This is a tradeoff that is an interesting avenue for future work.

\subsection{Multi-View Setting}
\reminder{Multi-View Setting is an important part. We can discuss some open questions and some possible solutions in the future work section.}
